...
<script lang="ts">
  ...
  const treeAtlasMeta = [
    {
      url: 'https://kljuyenllyvqfgpjnfrz.supabase.co/storage/v1/object/sign/static%20assets/bottle/trees-pixelart-Recovered.diddypng.png?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJzdGF0aWMgYXNzZXRzL2JvdHRsZS90cmVlcy1waXhlbGFydC1SZWNvdmVyZWQuZGlkZHlwbmcucG5nIiwiaWF0IjoxNzI3ODc2NTIzLCJleHAiOjE3NTk0MTI1MjN9.bSiiBT3ftyNg-10BROKY9r0ns7m5sDrCJ6q11bp_eF0&t=2024-10-02T13%3A41%3A56.817Z',
      type: 'rowColumn',
      width: 8,
      height: 3,
      animations: [
